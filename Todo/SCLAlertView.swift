...
public class SCLAlertView: UIViewController {
    ...
    //3d434e
    public func showEdit(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0x3D434E, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
